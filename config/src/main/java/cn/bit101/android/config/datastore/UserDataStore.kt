...
internal class UserDataStore @Inject constructor(
    ...
    private val LOGIN_WEB_VPN = booleanPreferencesKey("login_web_vpn")
    val loginWebVpn = PreferencesDataStoreItem(LOGIN_WEB_VPN, false, preferences.SETTING_DATASTORE)
